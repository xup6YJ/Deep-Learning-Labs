...
class MyConditionedUNet(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        down_block_types: Tuple[str] = ("DownBlock2D", "AttnDownBlock2D", "ResnetDownsampleBlock2D", "CrossAttnDownBlock2D"),
        up_block_types: Tuple[str] = ("AttnUpBlock2D", "UpBlock2D", "ResnetUpsampleBlock2D", "CrossAttnUpBlock2D"),
