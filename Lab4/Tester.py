...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_root',     type=str,  default = '/media/bspubuntu/3TBNAS/DLP/Lab4/LAB4/20230809_2030_Cyclical_tfr_d_step0.1_weight', help="The path to save your data")
    ...
    parser.add_argument('--ckpt_path',     type=str,   default='/media/yclin/3TBNAS/DLP/Lab4/LAB4/20230809_2030_Cyclical_tfr_d_step0.1_weight/PSNR_35.87907872881208_epoch_67_loss_0.00519.ckpt', help="The path of your checkpoints")   
